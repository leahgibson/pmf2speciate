"""
Generate synthetic test data from SPECIATE profiles using uncertainties.
...
def generate_samples_with_uncertainty(weight_row, uncertainty_row):
    ...
    synthetic_df = pd.DataFrame(samples, columns=weight_row.index)
...
combined_samples.to_parquet(
    "./data/processed/test_samples.parquet", compression="snappy"
)
